...
import ReservationMobileCnt from './components/reservation/ReservationMobileCnt';
import ReservationTablet from './components/reservation/ReservationTablet';
import SlidePanel from './components/reservation/SlidePanel';
...
function ActivityDetailPage({ params }: PageProps) {
